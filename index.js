...
var supabaseKey = process.env.REACT_APP_SUPABASE_KEY;
...
//     console.log(data);
//   });
var apiTry = function () { return __awaiter(_this, void 0, void 0, function () {
    var _a, warhammer_40k_weapons, error;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, supabase
                    ...
                    .range(0, 2)];
            case 1:
                _a = _b.sent(), warhammer_40k_weapons = _a.data, error = _a.error;
